...
--     functions.paddleMovement(rocketL, rocketR, rocketSpeed, dt, world)
--     -- rockets.dealWithMovementDERP(dt, world)
--     functions.ballMovement(ball, dt, world)
--     functions.ballBounce(ball, rocketL, rocketR, world, dt)
end

function love.draw()
    ball.bounce(world, rockets) -- to nie ma być tu.
    -- rockets.left.draw()
